...
export const OPEN_SIDE_TOOL_BAR = 'OPEN_SIDE_TOOL_BAR';
export const CLOSE_SIDE_TOOL_BAR = 'CLOSE_SIDE_TOOL_BAR';
export const TOGGLE_SIDE_TOOL_BAR = 'TOGGLE_SIDE_TOOL_BAR';